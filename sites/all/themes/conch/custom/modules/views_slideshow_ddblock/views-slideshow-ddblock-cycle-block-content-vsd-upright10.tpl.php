...
/*!
 * Views Slideshow Dynamic display block module template: vsd-upright10 - content template
...
/**
 * @file
 * Dynamic display block module template: vsd-upright10 - content template
 *
 * Available variables:
